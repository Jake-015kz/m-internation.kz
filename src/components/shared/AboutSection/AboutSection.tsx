  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[80rem] px-3 md:px-6 lg:px-8">
        {/* Header — left-aligned */}
        <div ref={headerRef} className="mb-12 md:mb-20 text-left max-w-[36rem]" style={{ opacity: 1 }}>
          <h2
            id="about-title"
            ...
            {TIMELINE_ITEMS.map((item, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 md:gap-2">
                  ...
                  <p className="font-body text-xs md:text-sm leading-[1.45] text-[var(--fg-muted)] max-w-[32rem]">
        ...
        {/* CTA */}
        <div ref={ctaRef} className="mt-10 md:mt-16" style={{ opacity: 1 }}>
          <Link
            href={`/${locale}/about`}
