...
export const products: Product[] = [
  ...
  },
  {
    slug: 'magicare',
    name: 'Magicare',
    description: 'Инновационный продукт по уходу за кожей. Комплексный уход для здоровья и красоты кожи с натуральными ингредиентами. Скоро в продаже.',
  ...
  },
  {
    slug: 'mifresh',
    name: 'MiFresh',
    description: 'Продукт для ежедневной гигиены. Свежесть и чистота на весь день. Натуральный состав без агрессивной химии. Скоро в продаже.',
  ...
  },
  {
    slug: 'essential-oil',
    name: 'Essential Oil',
    description: 'Эфирные масла для ароматерапии и велнеса. Натуральные масла для расслабления, восстановления и создания гармоничной атмосферы. Ароматерапия для здоровья и душевного равновесия.',
  ...
  },
  {
    slug: 'relax',
    name: 'Relax Tea',
    description: 'Расслабляющий травяной чай. Натуральный состав для снятия стресса, улучшения сна и восстановления нервной системы. Без кофеина. Успокаивающий травяной сбор для глубокого сна и пищеварения.',
  ...
  },
  {
    slug: 'miwellness',
    name: 'MiWellness',
    description: 'Продукт для здорового образа жизни. Комплексная поддержка организма для повседневного благополучия и профилактики. Скоро в продаже.',
  ...
  },
  {
    slug: 'shaker',
    name: 'Shaker',
    description: 'Шейкер для приготовления коктейлей и напитков. Удобный и стильный аксессуар для здорового питания и спортивного рациона. Скоро в продаже.',
  ...
  },
  {
    slug: 'ebooster',
    name: 'Ebooster',
    description: 'Энергетический активатор воды. Основан на концепции Ци (ТКМ). Дальнее инфракрасное излучение для структурирования воды и повышения её энергетического потенциала. Структурированная вода для здоровья.',
  ...
  },
  {
    slug: 'chai-relax',
    name: 'Чай Relax',
    description: 'Расслабляющий травяной чай. Натуральный состав для снятия стресса, улучшения сна и восстановления нервной системы. Без кофеина. Успокаивающий травяной сбор.',
